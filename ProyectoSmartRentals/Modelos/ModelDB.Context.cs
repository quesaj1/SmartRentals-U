...
namespace ProyectoSmartRentals.Modelos
{
    ...
    public partial class SmartRentalsEntities1 : DbContext
    {
        ...
        public virtual int sp_EliminarAlquiler(Nullable<int> v_id)
        {
            var v_idParameter = v_id.HasValue ?
                new ObjectParameter("v_id", v_id) :
                new ObjectParameter("v_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_EliminarAlquiler", v_idParameter);
        }
        ...
        public virtual int sp_InsertarAlquiler(string v_UbicacionExacta, string v_TipoPropiedad, string v_Detalles, Nullable<int> v_Distrito, Nullable<int> v_Canton, Nullable<int> v_Provincia, string v_ImagenURL)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_InsertarAlquiler", v_UbicacionExactaParameter, v_TipoPropiedadParameter, v_DetallesParameter, v_DistritoParameter, v_CantonParameter, v_ProvinciaParameter, v_ImagenURLParameter);
        }
        ...
        public virtual ObjectResult<sp_RetornaAlquiler_Result> sp_RetornaAlquiler(Nullable<int> v_alq_id_Propiedad, string v_alq_tipo_Propiedad)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_RetornaAlquiler_Result>("sp_RetornaAlquiler", v_alq_id_PropiedadParameter, v_alq_tipo_PropiedadParameter);
        }
