    ...
    <div id="divForm" style="margin-top: 12%; margin-left: 15%; margin-right: 15%">
        ...
        <div class="form-row" style="margin-top: 5%; margin-bottom: 5%">
            <div class="form-group col-md-6">
                ...
                <asp:TextBox ID="txtUbicacionExacta" type="text" CssClass="form-control" runat="server" MaxLength="40" placeholder="Ingrese una ubicación" ForeColor="Black"></asp:TextBox>
                <br />
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <asp:TextBox ID="txtDetalles" type="text" CssClass="form-control" runat="server" MaxLength="40" placeholder="Ingrese el detalle" ForeColor="Black"></asp:TextBox>
                <br />
            </div>
