<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterSmartRentals.Master" AutoEventWireup="true" CodeBehind="frm_SolicitudDesocuparCliente.aspx.cs" Inherits="ProyectoSmartRentals.Formularios.frm_SolicitudDesocuparCliente" %>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.js"></script>
    ...
    <div id="divForm" style="margin-top: 12%; margin-left: 15%; margin-right: 15%">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                <!-- Fecha de inicio -->
                <label for="txtFechaInicio">Fecha de desalojo <span style="color: red;">*</span></label>
                <br />
