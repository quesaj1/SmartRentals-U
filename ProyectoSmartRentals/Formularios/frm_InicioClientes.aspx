<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterSmartRentals.Master" AutoEventWireup="true" CodeBehind="frm_InicioClientes.aspx.cs" Inherits="ProyectoSmartRentals.Formularios.frm_InicioClientes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  .boton_personalizado:hover{
    ...
    <div style="margin-top: 10%; margin-bottom:5%;margin-left: 5%; margin-right: 5%" >
        ...
        <h1 style="text-align: center";  >Clientes</h1><br/><br/><br/>
