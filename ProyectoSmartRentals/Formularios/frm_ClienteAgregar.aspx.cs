        ...
        void AgregarCliente()
        {
            try
            {
                ...
                bool ClienteInsertar =
                    oCliente.InsertaCliente(adr_Cedula, adr_Nombre, adr_SegundoNombre, adr_PrimerApellido, adr_SegundoApellido, adr_FechaNacimiento, adr_TelefonoCasa, adr_TelefonoCelular, adr_Email);
