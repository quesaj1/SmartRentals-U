    ...
    <div id="divForm" style="margin-top: 12%; margin-left: 15%; margin-right: 15%">
        ...
        <div class="form-row" style="margin-top: 5%; margin-bottom: 5%">
            ...
            <div class="form-group col-md-6">
                ...
                <asp:TextBox ID="txtMonto" type="text" CssClass="form-control" ForeColor="Black" placeholder="0,0" runat="server" MaxLength="18" OnTextChanged="txtMonto_TextChanged" AutoPostBack="True"></asp:TextBox>
            </div>
            <div class="form-group col-md-6">
