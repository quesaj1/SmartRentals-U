...
/*Finaliza el estilo del select2 dropdownlist */
    ...
    <div id="divForm" style="margin-top:12%; margin-left:15%; margin-right:15%">
        ...
        <div class="form-group" style="text-align:center">
            <!-- Submit Button -->
            <asp:Button ID="btnModificar" runat="server" CssClass="boton_personalizado"  Text="Modificar" Font-Size="Medium" Height="49px" Width="111px" OnClick="btnAgregar_Click"  ValidationGroup="Save" />
            &nbsp;&nbsp;&nbsp;
