  ...
  .boton_personalizado:hover{
    ...
    <div id="divForm" style="margin-top:12%; margin-left:15%; margin-right:15%">
        ...
        <div class="form-group" style="text-align:center">
            <!-- Submit Button -->
            <asp:Button ID="btnModificar" runat="server" CssClass="boton_personalizado" Font-Size="Medium" Height="49px" Width="111px" Text="Modificar" OnClick="btnAgregar_Click" />
            &nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnAtras" CssClass="boton_personalizado" runat="server" Text="Atras" Font-Size="Medium" Height="49px" Width="111px" OnClick="btnAtras_Click"  PostBackUrl="~/Formularios/frm_AdminRentalsLista.aspx" />
            <br />
            <br />
