    ...
    <div id="divForm" style="margin-top: 7%;">
        ...
        <div class="form-row" style="margin-top: 5%; margin-bottom: 5%; overflow: hidden; padding-left: 33%; padding-right: 20%; text-align: center">
            ...
            <div style="text-align: center; padding: 1em; float: left">
                ...
                <br />
                <asp:TextBox ID="txtSearch" CssClass="form-control" onkeyup="Search_Gridview(this, 'ContentPlaceHolder1_grdListaContratos')" runat="server" Height="35px" Width="195px"></asp:TextBox>
            </div>
            &nbsp&nbsp
        ...
        <div style="text-align: center">
            ...
            <strong>
                <asp:HyperLink ID="hplAgregar" runat="server" NavigateUrl="frm_ContratoAgregar.aspx" Font-Size="Medium">Agregar Nuevo Contrato &nbsp <i class="fa fa-plus-circle" style="font-size:19px"></i></asp:HyperLink>
            </strong>
        </div>
